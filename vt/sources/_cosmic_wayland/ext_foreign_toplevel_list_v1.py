...
class ExtForeignToplevelHandleV1Resource(Resource[ExtForeignToplevelHandleV1]):
...
class ExtForeignToplevelListV1Resource(Resource[ExtForeignToplevelListV1]):
...
class ExtForeignToplevelHandleV1Global(Global[ExtForeignToplevelHandleV1]):
    interface = ExtForeignToplevelHandleV1


class ExtForeignToplevelListV1Global(Global[ExtForeignToplevelListV1]):
    interface = ExtForeignToplevelListV1
