...
from .ext_foreign_toplevel_list_v1 import ExtForeignToplevelHandleV1Proxy
...
class ZcosmicToplevelInfoV1Proxy(Proxy[ZcosmicToplevelInfoV1]):
    ...
    def get_cosmic_toplevel(self, foreign_toplevel: ExtForeignToplevelHandleV1Proxy) -> ZcosmicToplevelHandleV1Proxy:
